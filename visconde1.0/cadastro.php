...
<body>
    <form method="POST" action="cadastro.php" id="principal">
        ...
        <br>
        <input id="input" required placeholder="Nome do responsável..." name="email"></input>
        <br>
        <input type="text" required id="input" placeholder="Email..." name="responsavel"></input>
  <br>
        <input type="input" id="input" required placeholder="Número de celular para contato..." name="numero"></input>
        <br>
        <select style="width: 300px;" id="input" placeholder="Formação" name="">
